...
<head>
    ...
    <link rel="stylesheet" href="admin_theme/css/owl.carousel.css" type="text/css">
      ...
      <!--right slidebar-->
      <link href="admin_theme/css/slidebars.css" rel="stylesheet">
  ...
  <section id="container" >
            ...
            <ul class="nav top-menu">
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="admin_theme/img/avatar-mini.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="admin_theme/img/avatar-mini2.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="admin_theme/img/avatar-mini3.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="admin_theme/img/avatar-mini4.jpg"></span>
                                <span class="subject">
    ...
    <script class="include" type="text/javascript" src="admin_theme/js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="admin_theme/js/jquery.scrollTo.min.js"></script>
    <script src="admin_theme/js/jquery.nicescroll.js" type="text/javascript"></script>
    <script src="admin_theme/js/jquery.sparkline.js" type="text/javascript"></script>
    <script src="admin_theme/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
    <script src="admin_theme/js/owl.carousel.js" ></script>
    <script src="admin_theme/js/jquery.customSelect.min.js" ></script>
    <script src="admin_theme/js/respond.min.js" ></script>

    <!--right slidebar-->
    <script src="admin_theme/js/slidebars.min.js"></script>

    <!--common script for all pages-->
    <script src="admin_theme/js/common-scripts.js"></script>

    <!--script for this page-->
    <script src="admin_theme/js/sparkline-chart.js"></script>
    <script src="admin_theme/js/easy-pie-chart.js"></script>
    <script src="admin_theme/js/count.js"></script>
